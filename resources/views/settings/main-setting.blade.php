                                ...
                                <div class="card-body">
                                    <div class=" row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="form-label">{{ __('Gtag Tracking ID') }}
                        ...
                        <form id="setting-form" action="{{ route('settings/social-setting/update') }}"
                            ...
                            <div class="card" id="settings-card">
                                ...
                                @php
                                    ...
                                    // if (Utility::getsettings('LINKEDINSETTING') == 'on') {
                                    //     $linkdin_class = 'block';
                                    // }
                                @endphp
                                <div class="card-body">
                                        ...
                                        <div class="col-md-4 form-check form-switch custom-switch-v1">
                                            <label class="custom-radio  mt-2 float-right">
                                                <input name="socialsetting[]"
                                                    ...
                                                    {{-- {{ (Auth::user()->type == 'Admin'? Utility::getsettings('PAYMENTSETTING'): Utility::getsettings('PAYMENTSETTING') == 'stripe')? 'checked': 'unchecked' }} --}}>
                                                {{-- <span class="custom-switch-indicator"></span> --}}
                                            </label>
                                        </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="google_redirect"
                                                                class="form-control"
                                                                value="{{ Utility::getsettings('GOOGLE_REDIRECT') }}"
                                        ...
                                        <div class="col-md-4 form-check form-switch custom-switch-v1">
                                            <label class="custom-radio  mt-2 float-right">
                                                <input name="socialsetting[]"
                                                    ...
                                                    {{-- {{ (Auth::user()->type == 'Admin'? Utility::getsettings('PAYMENTSETTING'): Utility::getsettings('PAYMENTSETTING') == 'razorpay')? 'checked': 'unchecked' }} --}}>
                                            </label>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="facebook_redirect"
                                                                class="form-control"
                                                                value="{{ Utility::getsettings('FACEBOOK_REDIRECT') }}"
                                        ...
                                        <div class="col-md-4 form-check form-switch custom-switch-v1">
                                            <label class="custom-radio mt-2 float-right ">
                                                <input name="socialsetting[]"
                                                    ...
                                                    {{-- {{ (Auth::user()->type == 'Admin'? Utility::getsettings('PAYMENTSETTING'): Utility::getsettings('PAYMENTSETTING') == 'paypal')? 'checked': 'unchecked' }} --}}>
                                            </label>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="github_client_id"
                                                                class="form-control"
                                                                value="{{ Utility::getsettings('GITHUB_CLIENT_ID') }}"
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="github_client_secret"
                                                                class="form-control"
                                                                value="{{ Utility::getsettings('GITHUB_CLIENT_SECRET') }}"
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="github_redirect"
                                                                class="form-control"
                                                                value="{{ Utility::getsettings('GITHUB_REDIRECT') }}"
                    ...
                    <div id="useradd-8" class="">
                        <form id="setting-form" action="{{ route('settings/stripe-setting/update') }}"
                            ...
                            <div class="card" id="settings-card">
                                ...
                                @php
                                    // dd(Utility::getsettings('RAZORPAYSETTING'));
                                    $paypal_class = 'd-none';
