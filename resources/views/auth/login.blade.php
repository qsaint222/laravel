    ...
    <div class="row align-items-center justify-content-center text-start">
        ...
        <div class="col-xl-6 text-center">
            <div class="mx-3 mx-md-5 mb-5" style="margin-top:95px;">
                <img src="{{ Storage::url(setting('app_logo')) ? Storage::url('uploads/appLogo/app-logo.png') : '' }}"  class="cust-logo"/>
            </div>
            <div class="card">
                <div class="card-body mx-auto">
                    ...
                    @if (Utility::getsettings('GOOGLESETTING') == 'on' || Utility::getsettings('FACEBOOKSETTING') == 'on' || Utility::getsettings('GITHUBSETTING') == 'on')
